...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <br>
            <a href="Logout" class="btn btn-danger"><i class="fa-solid fa-door-open"></i> Cerrar Session</a>
            <br>
            <br>
            ...
            <table class="table table-striped">
                ...
                <c:forEach var="item" items="${producto}">
                    <tr>
                        ...
                        <td><a href="ProductoControlador?action=delete&id=${item.id}" onclick="return(confirm('¿Esta seguro de eliminar este registro?'))">
